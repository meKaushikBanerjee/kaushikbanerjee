...
if(isset($_POST['create']))
{
  ...
  $name=$_POST['name'];
  $value=$_POST['value'];
  $sql="INSERT into skills(adminid,codeskillid,codeskillname,codeskillvalue) VALUES(:aid,:id,:name,:value)";
  $query = $dbh->prepare($sql);        
  ...
  {
    echo "<script>alert('Skills could not be added!');</script>";
  }
}
?>
...
<body>
  <script>
    function deleteskill(val) 
    {
      ...
      request.open("GET", "deleteskill.php?sid="+val , true);
      request.send();
    }
  </script>
                ...
                <tbody>
                  ...
                  ?>
                        <tr>
                          ...
                          <td width="20">
                            <a href="" onclick="deleteskill('<?php echo $result->codeskillid; ?>');" style="color: red;"><i class="fa fa-close"></i>Delete</a>
                          </td>
                        </tr>
                  <?php
                      }
